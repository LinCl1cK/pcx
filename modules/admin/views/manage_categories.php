    ...
    <header class="bg-primary text-white py-3">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="h4 mb-0">PCX Employee Dashboard - Manage Categories</h1>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="productManagementDropdown">
                            ...
                            <li><a class="dropdown-item active" href="<?= BASE_URL ?>/?r=admin/admin/manageCategories">Manage Categories</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
