 ...
 */
// Sync role definitions cleanly with the naming framework in nav.php
...
$footerIsAdmin = in_array($footerRole, ['admin', 'administrator', 'general admin', 'branch admin']);
$footerIsMgmt  = $footerIsAdmin || ($footerRole === 'manager');
?>
    ...
    <div class="container-fluid px-4">
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                <h6 class="text-uppercase fw-bold mb-3 text-secondary">
                    <?= $footerIsAdmin ? 'System Control' : 'Staff Resources'; ?>
                </h6>
                <ul class="list-unstyled small">
                    <li class="mb-2">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <?php else: ?>
                    <div class="p-2 bg-dark-subtle rounded border border-secondary mb-2 small">
                        ...
                        <span class="badge bg-info text-dark ms-1 text-uppercase role-badge">
                            <?= htmlspecialchars(ucwords($footerRole)) ?>
                        </span>
                    </div>
                    <div class="row g-2">
                        <div class="col-6">
                            <a href="<?= BASE_URL ?>/?r=admin/admin/dashboard" class="btn btn-outline-light btn-sm w-100 text-nowrap">
                                <i class="bi bi-speedometer2 me-1"></i> Portal
                            </a>
                        </div>
                        <div class="col-6">
                            <a href="<?= BASE_URL ?>/?r=auth/auth/logout" class="btn btn-outline-danger btn-sm w-100 text-nowrap">
        ...
        <div class="row align-items-center small text-secondary">
            <div class="col-md-6 text-center text-md-start">
                &copy; <?= date('Y') ?> <strong>PCX Store</strong> &middot; Internal Use Only
            </div>
            <div class="col-md-6 text-center text-md-end mt-2 mt-md-0">
                <span class="me-3 text-warning small">
                    <i class="bi bi-exclamation-triangle-fill me-1"></i> 
                    Confidential (<?= htmlspecialchars(strtoupper($footerRole ?: 'RESTRICTED')) ?>)
                </span>
                <a href="#" class="text-secondary text-decoration-none me-3 hover-white">Infosec Guidelines</a>
                <a href="#" class="text-secondary text-decoration-none hover-white">Data Privacy</a>
            </div>
        </div>
    </div>
</footer>
