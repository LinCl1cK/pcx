        ...
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <ul class="nav nav-underline ms-auto" role="tablist" id="authTabList">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link fw-bold" id="emp-tab-btn" data-bs-toggle="tab" data-bs-target="#empTab" type="button" role="tab" aria-controls="empTab" aria-selected="false">STAFF</button>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="regTab" role="tabpanel" aria-labelledby="reg-tab-btn">
                        ...
                        <form id="ajaxRegisterForm" method="post" action="<?= BASE_URL ?>/?r=auth/auth/register">
                            ...
                            <button type="submit" id="registerSubmitBtn" class="btn btn-dark w-100 py-2 fw-bold">Create Account</button>
                        </form>
                    </div>

                    <div class="tab-pane fade" id="empTab" role="tabpanel" aria-labelledby="emp-tab-btn">
                        ...
                        <form id="ajaxEmployeeForm" method="post" action="<?= BASE_URL ?>/?r=auth/auth/login">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Staff Username / Email</label>
                                <input type="text" name="login_id" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Password</label>
                            ...
                            <button type="submit" id="empSubmitBtn" class="btn btn-dark w-100 py-2">
                                <i class="bi bi-shield-lock me-1"></i>Staff Sign In
                            </button>
                        </form>
                    </div>
