...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom">
  <div class="container-fluid px-3">
    <a class="navbar-brand" href="<?= BASE_URL ?>/?r=admin/admin/dashboard">PCX Staff</a>
    ...
    <div class="collapse navbar-collapse" id="empNav">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 flex-wrap">
        <?php if ($isAdmin): ?>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle <?= in_array($navActive, ['products', 'categories', 'promotions'], true) ? 'active' : '' ?>" href="#" data-bs-toggle="dropdown">Catalog</a>
            <ul class="dropdown-menu">
        ...
        <?php elseif ($isSales): ?>
          ...
          <li class="nav-item"><a class="nav-link <?= $navActive === 'inventory' ? 'active' : '' ?>" href="<?= BASE_URL ?>/?r=inventory/inventory/index">Inventory</a></li>
        <?php elseif ($isTech): ?>
          <li class="nav-item"><a class="nav-link <?= $navActive === 'service' ? 'active' : '' ?>" href="<?= BASE_URL ?>/?r=service/service/index">My Service Tickets</a></li>
        <?php endif; ?>
      </ul>
